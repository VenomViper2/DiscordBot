  ...
  async execute(interaction, client) {
    const embed = new EmbedBuilder()
      ...
      .addFields([
        {
          name: `Devotion`,
          value: `It was once the case that all Clergy members held The Holiest Doctrine as immutable truths. Great effort was taken to ensure that the teachings were thoroughly spread amongst the Henges. However, as years passed, and the need for practicality grew, fewer and fewer efforts could be spared on this task.
          With reduced instruction in the way of the Holy Order, new acolytes gave less mind to the teachings, and once they became the new generation of Priests, they preached even less of the Great Faith in their travels. Now, whilst many Clergy still hold some belief in the tenets of the faith, few take it literally.
          `,
          inline: false,
        },
        {
            name: `Teachings`,
            value: `**"There is no higher holiness than the worship of the Henge."**\nIt should be little surprise to anyone that the great Henge Stones which protect mankind, would be considered the most divine of temples. As such, obeying their instructions is considered to be hallowed worship, and purposefully allowing them to fall is a deep heresy.
