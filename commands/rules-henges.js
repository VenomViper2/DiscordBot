  ...
  async execute(interaction, client) {
    const embed = new EmbedBuilder()
      ...
      .addFields([
        {
          name: `Description`,
          value: `The average henge is a 2 metre tall, 50cm diameter stone who's base sinks deep into the ground. In a 1.5 metre radius around it can be found 5 smaller stones, around 1 metre tall and 20cm in diameter. The exact details of each henge vary in terms of the shapes of the stones. Some are pointed, some are cuboid or prism shaped, and yet others still are perfectly cylindrical - but the basic dimensions remain consistent.
          The Central stone is a polished white stone with streaks of impurities marbled through it. The 5 surrounding stones tend to be a smooth dark material. In an active Henge, they all glow an azure blue, almost imperceptible in the sunlight, but undeniable. Engraved into each stone is a series of complex glyphs that glow a slightly harsher light, bright enough to read, but dim enough as to barely illuminate through a thin sheet of paper.
          `,
          inline: false,
        },
        {
